...
function getOwnerLogoImg(ownerName, size) {
  ...
  return '<span style="display:inline-flex;align-items:center;justify-content:center;width:' + size + 'px;height:' + size + 'px;background:#1A1A1A;color:#B87860;border-radius:4px;font-family:IBM Plex Mono,monospace;font-weight:700;font-size:' + Math.round(size * 0.35) + 'px;flex-shrink:0;vertical-align:middle;margin-right:10px;">' + initials + '</span>';
}
...
function getBrandLogoImg(brandGroup, size=24) {
  ...
  if (custom) {
    return '<span style="display:inline-flex;align-items:center;justify-content:center;width:' + size + 'px;height:' + size + 'px;background:' + custom.bg + ';color:' + custom.color + ';border-radius:4px;font-family:IBM Plex Mono,monospace;font-weight:700;font-size:' + Math.round(size*0.55) + 'px;flex-shrink:0;vertical-align:middle;margin-right:6px;">' + custom.letter + '</span>';
  }
  const domain = BRAND_DOMAINS[brandGroup];
  if (!domain) return '';
...
async function initReports() {
  ...
  try {
    ...
    allCities.forEach(cityMeta => {
      ...
      card.innerHTML = `
        <div style="font-family:IBM Plex Mono,monospace;font-size:1rem;font-weight:600;color:var(--text);margin-bottom:3px;">${cityMeta.city}</div>
        ...
        <button class="report-generate-btn" data-city="${cityMeta.city}"
          ...
          font-family:IBM Plex Mono,monospace;font-size:0.75rem;font-weight:600;letter-spacing:0.05em;text-transform:uppercase;
    ...
    return '<div class="owner-card" onclick="showOwnerDetail(\'' + fmt.esc(o.id) + '\')">' +
      '<div style="display:flex;align-items:center;justify-content:space-between">' +
        '<div style="display:flex;align-items:center">' +
          ...
          '<div>' +
            '<div style="font-family:IBM Plex Mono,monospace;font-size:15px;font-weight:600;color:var(--text)">' + fmt.esc(o.name) + '</div>' +
...
function renderOwnerDetail(o) {
  ...
  document.getElementById('owner-detail-header').innerHTML =
    '<div style="display:flex;align-items:center;gap:12px;margin-bottom:14px">' +
      ...
      '<div>' +
        '<h1 style="font-family:IBM Plex Mono,monospace;font-size:22px;font-weight:700;color:var(--text);margin:0">' + fmt.esc(o.name) + '</h1>' +
