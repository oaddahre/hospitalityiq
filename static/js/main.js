...
async function initReports() {
  ...
  try {
    ...
    allCities.forEach(cityMeta => {
      ...
      card.innerHTML = `
        <div style="font-family:Geist Mono,monospace;font-size:1rem;font-weight:600;color:var(--text);margin-bottom:3px;">${cityMeta.city}</div>
    ...
    return '<div class="owner-card" onclick="showOwnerDetail(\'' + fmt.esc(o.id) + '\')">' +
      '<div style="display:flex;align-items:center;justify-content:space-between">' +
        '<div style="display:flex;align-items:center">' +
          ...
          '<div>' +
            '<div style="font-family:Geist Mono,monospace;font-size:15px;font-weight:600;color:var(--text)">' + fmt.esc(o.name) + '</div>' +
...
function renderOwnerDetail(o) {
  ...
  document.getElementById('owner-detail-header').innerHTML =
    '<div style="display:flex;align-items:center;gap:12px;margin-bottom:14px">' +
      ...
      '<div>' +
        '<h1 style="font-family:Geist Mono,monospace;font-size:22px;font-weight:700;color:var(--text);margin:0">' + fmt.esc(o.name) + '</h1>' +
